...
import { ErrorFallback } from 'widgets/ErrorFallback/ErrorFallback';
...
> {
  ...
  public render(): React.ReactNode {
    ...
    if (typeof children === 'function') {
      // eslint-disable-next-line @typescript-eslint/no-unsafe-return -- Temporary avoids the lint error problem
      return children();
    }
